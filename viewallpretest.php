             ...
             <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                <button class="btn btn-primary" type="button" data-bs-toggle="modal" data-bs-target="#createPreTestModal">Create Pre-Test</button>
                            
                                <div class="container-fluid mt-5">
                                    <?php $pretest->showPreTestFunc_question(); ?>
                                </div>
                                <?php endif;?>
