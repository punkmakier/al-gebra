                            ...
                            <div class="col-12">
                                <div class="page-title-box">
                                    <div class="page-title-right">
                                        ...
                                        <?php if($showConcept->getCountConcept(2,5)):?>
                                            <a href="lesson2concept5_checkpoint.php" class="btn btn-info mt-2">Take Checkpoint Exam</a>
                                        <?php endif; ?>
                                    </div>
                                ...
                                <div class="container-fluid mt-3" id="readingLM" style="display:none;">
                                    ...
                                    <?php $checkpoint = $displayCheckpoint->checkAttempt($UserID);
                                        if($checkpoint == 1){
                                           $showConcept->showConcept(2,5,1,2);
                                        }else{
                                            $showConcept->showConcept(2,5,1,1);
                                        }
                                ...
                                <div class="container-fluid mt-3" id="audioLM" style="display:none;">
                                    ...
                                    <?php $checkpoint = $displayCheckpoint->checkAttempt($UserID);
                                        if($checkpoint == 1){
                                           $showConcept->showConcept(2,5,2,2);
                                        }else{
                                            $showConcept->showConcept(2,5,2,1);
                                        }
                                ...
                                <div class="container-fluid mt-2" id="visualLM" style="display:none;">
                                    ...
                                    <?php $checkpoint = $displayCheckpoint->checkAttempt($UserID);
                                        if($checkpoint == 1){
                                           $showConcept->showConcept(2,5,3,2);
                                        }else{
                                            $showConcept->showConcept(2,5,3,1);
                                        }
