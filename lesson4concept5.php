                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box">
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            ...
                                            <li class="breadcrumb-item active">Concept 5</li>
                                        </ol>
                                        <?php if($showConcept->getCountConcept(4,5)):?>
                                            <a href="lesson4concept5_checkpoint.php" class="btn btn-info mt-2">Take Checkpoint Exam</a>
                                        <?php endif; ?>
                                    </div>
                                ...
                                <div class="container-fluid mt-3" id="readingLM" style="display:none;">
                                    ...
                                    <input type="hidden" value="5" id="ConceptID">
                                    ...
                                    <?php $checkpoint = $displayCheckpoint->checkAttempt($UserID);
                                        if($checkpoint == 1){
                                           $showConcept->showConcept(4,5,1,2);
                                        }else{
                                            $showConcept->showConcept(4,5,1,1);
                                        }
