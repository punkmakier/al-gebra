                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box">
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            <li class="breadcrumb-item"><a href="javascript: void(0);">Lesson 4</a></li>
                                            <li class="breadcrumb-item active">Concept 4</li>
                                        </ol>
                                        <?php if($showConcept->getCountConcept(4,4)):?>
                                            <a href="lesson4concept4_checkpoint.php" class="btn btn-info mt-2">Take Checkpoint Exam</a>
                                        <?php endif; ?>
                                    </div>
                                    <h4 class="page-title">Concept 4</h4>
                                ...
                                <div class="container-fluid mt-3" id="readingLM" style="display:none;">
                                    <input type="hidden" value="4" id="LessonID">
                                    <input type="hidden" value="4" id="ConceptID">
                                    ...
                                    <?php $checkpoint = $displayCheckpoint->checkAttempt($UserID);
                                        if($checkpoint == 1){
                                           $showConcept->showConcept(4,4,1,2);
                                        }else{
                                            $showConcept->showConcept(4,4,1,1);
                                        }
                                    
                                    ?>
                           
                                </div>
                                <div class="container-fluid mt-4" id="audioLM" style="display:none;">
                                    <input type="hidden" value="4" id="LessonIDAud">
                                    <input type="hidden" value="4" id="ConceptIDAud">
                                    <input type="hidden" value="Audio" id="LearningToolIDAud">
                                    <input type="hidden" value="<?php echo $_SESSION['UserID'] ?>" id="useridIDAud">
                                    <?php $checkpoint = $displayCheckpoint->checkAttempt($UserID);
                                        if($checkpoint == 1){
                                           $showConcept->showConcept(4,4,2,2);
                                        }else{
                                            $showConcept->showConcept(4,4,2,1);
                                        }
                                    
                                    ?>
                                </div>
                                <div class="container-fluid mt-2" id="visualLM" style="display:none;">
                                    <input type="hidden" value="4" id="LessonIDVisual">
                                    <input type="hidden" value="4" id="ConceptIDVisual">
                                    <input type="hidden" value="Visual" id="LearningToolIDVisual">
                                    <input type="hidden" value="<?php echo $_SESSION['UserID'] ?>" id="useridIDVisual">
                                    <?php $checkpoint = $displayCheckpoint->checkAttempt($UserID);
                                        if($checkpoint == 1){
                                           $showConcept->showConcept(4,4,3,2);
                                        }else{
                                            $showConcept->showConcept(4,4,3,1);
                                        }
