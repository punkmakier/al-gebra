                            ...
                            <div class="col-12">
                                ...
                                <div class="container-fluid mt-3">            
                                    ...
                                    <?php $checkpoint = $displayCheckpoint->checkAttempt($UserID);
                                        if($checkpoint == 1){
                                           $displayQuestions->showTestExam("PostTest",4,$UserID,2);
                                        }else{
                                           $displayQuestions->showTestExam("PostTest",4,$UserID,1);
                                        }
