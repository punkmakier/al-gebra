                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box">
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            ...
                                            <li class="breadcrumb-item active">Concept III</li>
                                        </ol>
                                        <?php if($showConcept->getCountConcept(2,4)):?>
                                            <a href="lesson2concept4_checkpoint.php" class="btn btn-info mt-2">Take Checkpoint Exam</a>
                                        <?php endif; ?>
                                    </div>
                                ...
                                <div class="container-fluid mt-3" id="readingLM" style="display:none;">
                                    <input type="hidden" value="2" id="LessonID">
                                    ...
                                    <?php $checkpoint = $displayCheckpoint->checkAttempt($UserID);
                                        if($checkpoint == 1){
                                           $showConcept->showConcept(2,4,1,2);
                                        }else{
                                            $showConcept->showConcept(2,4,1,1);
                                        }
                                ...
                                <div class="container-fluid mt-3" id="audioLM" style="display:none;">
                                    <input type="hidden" value="2" id="LessonIDAud">
                                    ...
                                    <?php $checkpoint = $displayCheckpoint->checkAttempt($UserID);
                                        if($checkpoint == 1){
                                           $showConcept->showConcept(2,4,2,2);
                                        }else{
                                            $showConcept->showConcept(2,4,2,1);
                                        }
                                    
                                    ?>
                                </div>
                                <div class="container-fluid mt-2" id="visualLM" style="display:none;">
                                    <input type="hidden" value="2" id="LessonIDVisual">
                                    ...
                                    <?php $checkpoint = $displayCheckpoint->checkAttempt($UserID);
                                        if($checkpoint == 1){
                                           $showConcept->showConcept(2,4,3,2);
                                        }else{
                                            $showConcept->showConcept(2,4,3,1);
                                        }
